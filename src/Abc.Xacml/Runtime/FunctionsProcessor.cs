...
#pragma warning disable 1591 // Missing XML comment
    ...
    public sealed class FunctionsProcessor {
        ...
        delegate TRet EnumerableToGenericParamWithOneArg<in T1, in T2, out TRet>(T2 arg, params T1[] values);
...
#region Regex functions
        ...
        /// s a Perl syntax, so .NET should be supported
        /// Maybe nead use RegexOptions parameter
                ...
                if (processor == null) {
                    lock (Locker) {
                        if (processor == null) {
                            ...
                            foreach (var t in ExtensibilityManager.GetExportedTypes<IFunctionsExtender>()) {
